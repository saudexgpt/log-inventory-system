    ...
    <div v-if="page.option=='list'" class="box">
      <div class="box-header">
        ...
        <span class="pull-right">
          <a v-if="canCreateNewProduct" class="btn btn-info" @click="page.option = 'add_new'"><i class="el-icon-plus" /> Add New Product</a>
          <router-link :to="{ name: 'ItemStocks' }" class="btn btn-warning"><i class="el-icon-s-home" /> Products in Warehouses</router-link>
